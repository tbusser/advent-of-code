...
Today was a fun challenge. It seemed hard at first but as I got started it turned out to be surprisingly simple. To find the solution I figured it would be convenient to reduce the list of rules to just the rules whose numbers are both present in the update. With this subset of rules part 1 was as simple and making sure that the first number of a rule occurs in the update before the second number of the rule. When this is true for all applicable rules, the update is valid.
