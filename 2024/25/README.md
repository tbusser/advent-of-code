...
A simple challenge to finish this edition of Advent of Code. Just a bit of work to parse the input and create the heights per column. Once that was sorted finding the key/lock pairs without any overlap was fairly trivial.
