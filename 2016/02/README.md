...
With the new implementation it is possible to create any key configuration I could want. Following the directions became as easy as accessing the direction from the `neighbors` object and defaulting to the current position in case the requested direction didn't have a neighbor.
